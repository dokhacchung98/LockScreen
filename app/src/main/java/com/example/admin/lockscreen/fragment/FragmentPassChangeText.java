...
public class FragmentPassChangeText extends Fragment implements View.OnClickListener {
    private View view;
        ...
        switch (v.getId()) {
            ...
            case R.id.btnXong:
                if (pass.length() == 4) {
                    ...
                    menuActivity.switchFragment(menuActivity.getFragmentPassChangeText2());
                }
                break;
        }
        Log.e("PA", pass);
